package com.example.boleto.errors;
...
//		m.put("errors", new String[]{e.getMessage()});
		m.put("errors", "Erro realizando conversão do conteúdo recebido");
	...
	public void handleAmqpException(AmqpException e) {
		log.info("Erro enviando/recebendo mensagem", e);
	}
}
